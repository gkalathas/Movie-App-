...
import net.geoge.movieapp.adapters.MovieRecyclerView;
import net.geoge.movieapp.adapters.OnMovieListener;
import net.geoge.movieapp.models.MovieModel;
import net.geoge.movieapp.viewmodels.MovieListViewModel;
import net.george.movieapp.R;
